...
public class hellicopter extends Geometries {
    ...
    this.add(createRectangleZRotate(center.add(new Vector(size * 5, size * 5, 0).normalize().scale(size * 5)).add(new Vector(size * 15, -size, 0)).add(new Vector(0, 0, size)),
                            size * 5, size,angleBack,new Vector(0,0,1))
        .setEmisson(emission)
        .setMaterial(material));
    // Polygon tailRotorWingY;
    this.add(createRectangleZRotate(center.add(new Vector(size * 5, size * 5, 0).normalize().scale(size * 5)).add(new Vector(size * 15, -size, 0)).add(new Vector(0, 0, size)),
                            size, size * 5,angleBack,new Vector(0,0,1))
        .setEmisson(emission)
        .setMaterial(material));
