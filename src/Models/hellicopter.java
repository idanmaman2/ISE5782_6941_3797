...
public class hellicopter extends Geometries {
    ...
    this.add(createRectangleZRotate(center.add(new Vector(size * dimrx, size * dimry, 0).normalize().scale(size * 5)).add(new Vector(size * 15, -size, 0)).add(new Vector(0, 0, size)),
        ...
        this.add(new Triangle(center.add(new Vector(size * dimrx * 0.8,0, size * dimrz)),
        center.add(new Vector(size * dimrx * 0.8, size*dimry *0.6, size * dimrz )),
        center.add(new Vector(-size * dimrx *0.8 , 0, size * dimrz)))
.setEmisson(emission)
.setMaterial(material));
