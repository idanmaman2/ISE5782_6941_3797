...
public class Elepsoaide extends Sphere{
    ...
    public List<GeoPoint> findGeoIntersectionsHelper(Ray rayC){
        ...
        double r12 = this.radius * this.radius , r22 = this.radius2 * this.radius2  , r32 = this.radius3 * this.radius3 ; 
